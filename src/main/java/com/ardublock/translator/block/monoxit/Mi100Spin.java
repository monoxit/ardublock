...
public class Mi100Spin extends TranslatorBlock
{

	public Mi100Spin(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
    ...
    String ret = "\t" + instanceName + ".spin(" + duration + ");\n";
